...
* 
*   - Busy delay time testing: dly5us, dly5ms, dly1s
*       delay 1 sec.
*       print 1sec. up
* 
* 
...
{
  int i = 1;
  while(i <= 933)       // 5us busy processing
  {
    ++i;
  }
}
...
{
  int i = 1;
  while(i <= 200)       // 1sec. busy processing
  {
    dly5ms();
    ++i;
  }
