...
*
* Sample Program hw0a7imu3i2c9250   ***  ***
*   - for MPU-9250 IMU chip, accelerometer and gyroscope reading  examples
*   - accelerometer X, Y, Z, and gyroscope X, Y, Z examples
*   - this program originally designed for MPU-6050,
*   -   so the magnetometer in MPU-9250 is not used by this sample program
*   - I2C interface with Raspberry Pi 4 computer and MPU-9250 IMU chip
...
*       Updated by: K.Choi
*
* Genetic MPU-9250 IMU board connected to I2C pins of Raspberry Pi 4 computer
* (low cost MPU-9250 IMU board available on Amazon.com, $10.00/board - 2022)
*
***************************************************/
